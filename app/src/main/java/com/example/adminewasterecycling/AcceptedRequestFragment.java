...
import com.example.adminewasterecycling.Model.Product;
...
public class AcceptedRequestFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.fragment_accepted_request, container, false);
    ...
    private void Display(final String Email, final String adminName, final String adminImage) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                acceptedRequestAdapter = new AcceptedRequestAdapter(getActivity(), productList, Email, adminName, adminImage);
